...
#         get cases
df <- readxl::read_excel(paste0(inpath,"County_Case_Data_2020-05-12.xlsx"))
...
df <- readxl::read_excel(paste0(inpath,"Deaths_by_County_2020-05-12.xlsx"))

my_columns <- c(1, 9:12, 14:72)
