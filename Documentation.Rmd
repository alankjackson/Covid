...
Basically, I fit a line in a sliding window to the cumulative case points,
...
3-point median smoothing filter to help clean up spikes in the data due
...
The last item, deaths divided by number of cases, should expose testing issues.
